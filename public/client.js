...
let isGameOver = false; // [추가] 게임 종료 상태 플래그
...
// [추가] 게임 종료 후 버튼 텍스트/기능 변경을 위한 함수
...
socket.on('chat message', (data) => {
    ...
    if (user.role === 'streamer') {
        ...
        if (currentMode !== 'guess_group' && user.fanGroup) {
